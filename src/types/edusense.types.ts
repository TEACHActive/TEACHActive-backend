...
export class VideoFrame {
  ...
  constructor(data: any) {
    ...
    if (data.timestamp) this.timestamp = DateTime.fromISO(data.timestamp);
...
export class AudioFrame {
  ...
  constructor(data: any) {
    ...
    this.channel = data.channel;
    if (data.audio) this.audio = new Audio(data.audio);
  }
}
...
export class Person {
  ...
  constructor(data: any) {
    ...
    if (data.inference) this.inference = new VideoInference(data.inference);
  }
}
...
export class VideoInference {
  ...
  constructor(data: any) {
    if (data.posture) this.posture = new Posture(data.posture);
    if (data.face) this.face = new Face(data.face);
    if (data.head) this.head = new Head(data.head);
...
export class Audio {
  ...
  constructor(data: any) {
    ...
    if (data.inference) this.inference = new AudioInference(data.inference);
  }
}
...
export class AudioInference {
  ...
  constructor(data: any) {
    if (data.speech) this.speech = new Speech(data.speech);
  }
}
